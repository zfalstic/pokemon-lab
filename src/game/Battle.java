...
public class Battle {
	...
	public void playRound() {
		...
		if(this.getP2().getHealth() == 0) {
			System.out.println("\n" + this.getP2().getName() + " has fainted. " + this.getP1().getName() + " has gained 40 exp.");
			return;
		}
		System.out.println("\n" + this.getP2().getName() + " is now at " + this.getP2().getHealth() + " hp.");
		
		this.getP2().attack(this.getP1());
		if(this.getP1().getHealth() == 0) {
			System.out.println("\n" + this.getP1().getName() + " has fainted. " + this.getP2().getName() + " has gained 40 exp.");
			return;
		}
		System.out.println("\n" + this.getP1().getName() + " is now at " + this.getP1().getHealth() + " hp.");
	}
